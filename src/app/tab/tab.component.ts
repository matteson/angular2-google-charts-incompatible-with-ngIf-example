import {
  NgModule, Component, ElementRef, Input, Output, EventEmitter, AfterContentInit, ContentChildren, QueryList,
  OnDestroy
} from '@angular/core';
...
export class TabView implements AfterContentInit, OnDestroy/*, BlockableUI*/ {
